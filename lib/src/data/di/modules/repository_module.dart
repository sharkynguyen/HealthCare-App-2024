...
import 'package:health_care_app/src/data/repository/advice_repository_impl.dart';
...
class RepositoryModule {
  static Future<void> configureRepositoryModuleInjection() async {
    ...
    injector.registerSingleton<PersonalRepository>(PersonalRepositoryImpl());

    injector.registerSingleton<AdviceRepository>(AdviceRepositoryImpl());
  }
}
